...
export default function ConceptPage({ active }: { active: string }) {
  ...
  return (
    ...
    >
      {/* 🔹 TOP IMAGE GRID */}
      <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 px-2 md:px-12 pt-2 md:pt-4">
        {images.map((src, i) => (
          <div
            key={i}
            className="relative w-full h-[18vh] md:h-[35vh] overflow-hidden rounded-md border border-gray-200"
          >
            <Image
              src={src}
              alt={`Concept ${i + 1}`}
      ...
      <div className="flex-1 flex flex-col justify-between px-4 md:px-12 py-8 md:py-10">
        ...
        <div className="flex justify-center md:justify-end">
          <div className="max-w-[1000px] text-center md:text-right">
            <h2 className="text-xl md:text-3xl tracking-[0.15em] md:tracking-[0.2em] font-semibold mb-4 md:mb-6 mt-6 md:mt-24">
              CONCEPT
            </h2>

            <div className="text-sm md:text-base text-gray-700 leading-[1.6] md:leading-[1.8]">
              <p>
                Inspired by the wabi-sabi ethos and Japandi style, the bungalow
                design embodies simplicity
                <br className="hidden md:block" />
